    ...
    <>
      ...
      <section className="section-padding bg-[#f1f5f9]" aria-label="Our key leadership team">
        <div className="container-custom">
          ...
          {/* Featured Key Person Profile - Er. Karun Pandey */}
          <motion.div
            initial="hidden" whileInView="visible" viewport={viewportOnce} variants={fadeUp}
            className="bg-white rounded-3xl p-6 sm:p-8 md:p-10 border border-gray-200 shadow-lg mb-12 relative overflow-hidden group"
          >
